...
const Temp = () => {
  ...
  return (
    <div className="test_name_generation">
      <h1>Testing random name generation</h1>
      <textarea value={randomName} readOnly></textarea>
      <button onClick={randomName=generateRandomName}>Generate</button>
    </div>
  );
};

export default test_name_generation;
