...
const SignUpPage = () => {
  ...
  const handleSignUp = (e) => {
    ...
    else if (!validateEmail(email)) tempErrors.email = messages.validation.emailInvalid;
    if (!password) tempErrors.password = messages.validation.required;
    if (!confirmPassword) tempErrors.confirmPassword = messages.validation.required;
    if (password !== confirmPassword) tempErrors.confirmPassword = messages.validation.passwordsDontMatch;
